...
class GUIFramework(Frame):
    ...
    def __init__(self,master=None):
        ...
        self.master.title("G.P.S. - Physics  v1.8")
    
        """Display the main window"
        with a little bit of padding"""
        self.grid(padx=10,pady=15,)
        self.CreateWidgets()
    ...
    def CreateWidgets(self):
        ...
        font1 = tkFont.Font(size = 10,weight = "bold")
        font2 = tkFont.Font(size = 10,weight = "bold")
        font3 = tkFont.Font(size = 10, slant="italic")
        font4 = tkFont.Font(size = 8,weight = "bold")
        ##LABELS                
        """File Path label"""
        self.lbFilePath = Label(self, text="Opening File Path : ", font=font2)
        self.lbFilePath.grid(row=0, column=0, sticky=E)

        """Save File Path Label"""        
        self.lbSaveFile = Label(self, text="Saving File Path : ", font=font2)
        self.lbSaveFile.grid(row=1, column=0, sticky=E)

        """Mass Label"""        
        self.lbMass = Label(self, text="Mass of Object : ", font=font2)
        self.lbMass.grid(row=2, column=0,sticky=E)

        """Kilogram Label"""        
        self.kGram = Label(self, text="Kg")
        self.kGram.grid(row=2, column=1,sticky=NW,ipadx=65)        

        """Vectors Label"""        
        self.vectorL = Label(self, text="Vectors:",font=font1)
        self.vectorL.grid(row=4, column=0,sticky=SW)

        
        """Units Label"""        
        self.unitsL = Label(self, text="Units:",font=font1)
        self.unitsL.grid(row=4, column=1,sticky=SW)

        """Trajectory Label"""        
        self.trajL = Label(self, text="Trajectory:               ",font=font1)
        self.trajL.grid(row=4, column=1,sticky=SE)

        """blank Label1"""        
        self.blank1L = Label(self, text="     ")
        self.blank1L.grid(row=3, column=1,sticky=S)

        """blank Label2"""        
        self.blank2L = Label(self, text="     ")
        self.blank2L.grid(row=8, column=1,sticky=S)

        """blank Label3"""        
        self.blank3L = Label(self, text="     ")
        self.blank3L.grid(row=10, column=1,sticky=S)        

        """CopyRight Label2"""        
        self.copyrL = Label(self, text="Copyright - G.S.C. Physics",font = font4)
        self.copyrL.grid(row=13, column=1,sticky=S)
        
        ##ENTRY
        """File Path Entry, set it to be a bit wider"""
        self.enOpenFile = Entry(self,width=40)
        self.enOpenFile.grid(row=0, column=1,sticky=NW)
        
        """Saving File Location entry"""
        self.enSaveFile = Entry(self,width=40)
        self.enSaveFile.grid(row=1, column=1,sticky=NW)
        
        """Mass entry"""
        self.enMass = Entry(self,width=10)
        self.enMass.grid(row=2, column=1,sticky=NW)
        ...
        ##Button1
        self.rButton1 = Radiobutton(self, text = "Walk/Run         ", variable = v, value=1)
        self.rButton1.grid(row=5,column=1,sticky=NE)

        base64img1 = """"""
        photo1 = PhotoImage(data=base64img1)

        ##photo1 = PhotoImage(file = "C:/Program Files/Gainesville State College - Physics Dpt/G.P.S - Physics/Icons/hiker.gif")
        w = Label(self, image=photo1)
        w.photo1 = photo1
        w.grid(row=5, column=1,sticky=N)
        ...
        ##Button2
        self.rButton2 = Radiobutton(self, text = "Car                    ", variable = v, value=2)
        self.rButton2.grid(row=6,column=1,sticky=NE)


        base64img2 = """"""
        photo2 = PhotoImage(data=base64img2)

        ##photo2 = PhotoImage(file = "C:/Program Files/Gainesville State College - Physics Dpt/G.P.S - Physics/Icons/cabs.gif")
        ww = Label(self, image=photo2)
        ww.photo2 = photo2
        ww.grid(row=6, column=1,sticky=N)
        ...
        ##Button3
        self.rButton3 = Radiobutton(self, text = "Motorcycle      ", variable = v, value=3)
        self.rButton3.grid(row=7,column=1,sticky=NE)

        base64img3 = """"""
        photo3 = PhotoImage(data=base64img3)

        ##photo3 = PhotoImage(file = "C:/Program Files/Gainesville State College - Physics Dpt/G.P.S - Physics/Icons/motorcycling.gif")
        www = Label(self, image=photo3)
        www.photo3 = photo3
        www.grid(row=7, column=1,sticky=N)




        ##Button4
        self.rButton4 = Radiobutton(self, text = "Maritime          ", variable = v, value=4)
        self.rButton4.grid(row=8,column=1,sticky=NE)

        base64img4 = """"""
        photo4 = PhotoImage(data=base64img4)

        ##photo4 = PhotoImage(file = "C:/Program Files/Gainesville State College - Physics Dpt/G.P.S - Physics/Icons/sailing.gif")
        wwww = Label(self, image=photo4)
        wwww.photo4 = photo4
        wwww.grid(row=8, column=1,sticky=N)


        ##Button2
        self.rButton5 = Radiobutton(self, text = "Aerial                ", variable = v, value=5)
        self.rButton5.grid(row=9,column=1,sticky=NE)        

        base64img5 = """"""
        photo5 = PhotoImage(data=base64img5)
        
        ##photo5 = PhotoImage(file = "C:/Program Files/Gainesville State College - Physics Dpt/G.P.S - Physics/Icons/airports.gif")
        wwww = Label(self, image=photo5)
        wwww.photo5 = photo5
        wwww.grid(row=9, column=1,sticky=N)
        ...
        unitsVar.set(1)
        ##Button3
        self.rButton3 = Radiobutton(self, text = "m/s", variable = unitsVar, value=1)
        self.rButton3.grid(row=5,column=1,sticky=NW)

        ##Button2
        self.rButton4 = Radiobutton(self, text = "mph", variable = unitsVar, value=2)
        self.rButton4.grid(row=6,column=1,sticky=NW)


        ##Type of Input File Button
        ##global fileVar
        ##fileVar = IntVar()
        ##fileVar.set(1)
        ##GPS File
        ##self.fButton1 = Radiobutton(self, text = "GPS File", variable = fileVar, value=1)
        ##self.fButton1.grid(row=8,column=1,sticky=NW)

        ##Text File
        ##self.fButton2 = Radiobutton(self, text = "Text File", variable = fileVar, value=2)
        ##self.fButton2.grid(row=10,column=1,sticky=NW)

        ##Excel File
        ##self.fButton3 = Radiobutton(self, text = "Excel File", variable = fileVar, value=3)
        ##self.fButton3.grid(row=9,column=1,sticky=NW)   
        ...
        checkVar.set(1)
        ##Velocity Check Mark
        self.cButton1 = Checkbutton(self, text = "Velocity", variable = checkVar)
        self.cButton1.grid(row=5,column=0,sticky=NW)

        ##Calculations Check Mark
        global checkVar2
        checkVar2 = IntVar()
        checkVar2.set(0)
        ##Calculations Check Mark
        self.cButton2 = Checkbutton(self, text = "Coordinates File", variable = checkVar2, font = font3)
        self.cButton2.grid(row=9,column=0, sticky=NW)

        ##Acceleration Check Mark
        global checkVar3
        checkVar3 = IntVar()
        checkVar3.set(1)
        ##Acceleration Check Mark
        self.cButton3 = Checkbutton(self, text = "Acceleration", variable = checkVar3)
        self.cButton3.grid(row=6,column=0,sticky=NW)
        ...
        checkVar4.set(1)
        ##Acceleration Check Mark
        self.cButton4 = Checkbutton(self, text = "Force", variable = checkVar4)
        self.cButton4.grid(row=7,column=0,sticky=NW)

        
        ##BUTTONS
        """Open Browse File Button"""
        self.btnOpenFile = Button(self, text="Browse", width = 7, bg="red",command=self.browseOpenFile)
        self.btnOpenFile.grid(row=0, column=2,padx=5)
        
        """Save Browse File Button"""
        self.btnSaveFile = Button(self, text="Browse",  width = 7, bg="red",command=self.browseSaveFile)
        self.btnSaveFile.grid(row=1, column=2,padx=5)
        
        """Calculate Button"""
        self.btnCalculate = Button(self, text="Calculate", height=1,width=8,bd=4,bg="green",command = self.readEntry)
        self.btnCalculate.grid(row=12, column=2,sticky=SW,)         

        ##self.btnCalculate = Button(self, text="Calculate", height=2,width=10,bd=4,bg="green",command = self.readEntry)
        ##self.btnCalculate.grid(row=2, column=1,sticky=NE,ipady=5,padx=10)        
    ...
    def browseOpenFile(self):
        fileName = askopenfilename(filetypes=[("All Files","*"),("Excel Files","*.xls"),("Text Files","*.txt")])
        self.enOpenFile.delete(0,END)
        self.enOpenFile.insert(0,fileName)


    def browseSaveFile(self):
        fileName = asksaveasfilename(filetypes=[("allfiles","*"),("textfiles","*.txt")])
        self.enSaveFile.delete(0,END)
        self.enSaveFile.insert(0,fileName)        

    def readEntry(self):
        openFilePath = self.enOpenFile.get()
        saveFilePath = self.enSaveFile.get()

        typeOfFile = IntVar()
        if openFilePath.find('.txt')== -1:
            if openFilePath.find('.xls')== -1:
                tkMessageBox.showinfo("Operation Failed","Only Text files (.txt) or Excel 2003 (.xls) files allowed")
                return
            else:
                typeOfFile.set(3)
        else:            
        ...
        massInput = self.enMass.get()
        runCode(openFilePath,saveFilePath,massInput,v.get(),checkVar.get(),checkVar2.get(),checkVar3.get(),unitsVar.get(),checkVar4.get(),typeOfFile.get())
